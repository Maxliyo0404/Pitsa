...
let pizza_datassa = [
    ...
    { id: 7, img: "./image/pissa11.svg", name: "Филадельфия кранч", description: "Семга, рис, сыр креметто, соус унаги, креветка, авокадо, чип...", price: 395, count: 1, badge: "",  style: " display: block; padding: 0; width: 100%; height: aspect-ratio: 1; object-fit: contain; border-top-left-radius: 8px; border-top-right-radius: 8px;" },
    { id: 8, img: "./image/pissa11.svg", name: "Филадельфия кранч", description: "Семга, рис, сыр креметто, соус унаги, креветка, авокадо, чип...", price: 475, count: 1, badge: "",  style: " display: block; padding: 0; width: 100%; height: aspect-ratio: 1; object-fit: contain; border-top-left-radius: 8px; border-top-right-radius: 8px;" },
