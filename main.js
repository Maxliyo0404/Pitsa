...
let pizza_datassam_1 = [
    ...
    { id: 3, img: "./image/napitki1.png", name: "Филадельфия кранч", description: "Семга, рис, сыр креметто, соус унаги, креветка, авокадо, чип...", price: 425, count: 1, badge: "",  style: " display: block; padding: 0; width: 100%; height: aspect-ratio: 1; object-fit: cover; border-top-left-radius: 8px; border-top-right-radius: 8px;" },
    { id: 4, img: "./image/napitki1.png", name: "Тигр мама", description: "Семга, рис, сыр креметто, соус унаги, креветка, авокадо, чип...", price: 525, count: 1, badge: "",  style: " display: block; padding: 0; width: 100%; height: aspect-ratio: 1; object-fit: cover; border-top-left-radius: 8px; border-top-right-radius: 8px;" },
    { id: 5, img: "./image/napitki1.png", name: "Супер Филадельфия", description: "", price: 425, count: 1, badge: "",  style: " display: block; padding: 0; width: 100%; height: aspect-ratio: 1; object-fit: cover; border-top-left-radius: 8px; border-top-right-radius: 8px;" },
    { id: 6, img: "./image/napitki1.png", name: "Тигр мама", description: "", price: 525, count: 1, badge: "",  style: " display: block; padding: 0; width: 100%; height: aspect-ratio: 1; object-fit: cover; border-top-left-radius: 8px; border-top-right-radius: 8px;" },
